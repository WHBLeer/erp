layui.define(["layer", "element"],
    function (b) {
        ...
        var a = {
            ...
            open: function (h) {
                ...
                (h.type == undefined) && (h.type = 1);
                    ...
                    h.success = function (i, j) {
                        a.showLoading(i, 2);
                        d(i).children(".layui-layer-content").load(h.url,
                            function () {
                                g ? g(i, j) : "";
                ...
                var e = c.open(h); (h.data) && (a.layerData["d" + e] = h.data);
                return e
            },
            layerData: {},
            getLayerData: function (e, f) {
                if (e == undefined) {
            ...
            showLoading: function (i, h, f) {
                ...
                if (i != undefined && (typeof i != "string") && !(i instanceof d)) {
                    ...
                    g = i.size;
                    i = i.elem
                } (!i) && (i = "body"); (h == undefined) && (h = 1); (g == undefined) && (g = "sm");
                g = " " + g;
        ...
        d(document).on("click", "*[ew-event]",
            function () {
                var e = d(this).attr("ew-event");
                var f = a.events[e];
                f && f.call(this, d(this))
            });
        d(document).on("mouseenter", "*[lay-tips]",
            function () {
