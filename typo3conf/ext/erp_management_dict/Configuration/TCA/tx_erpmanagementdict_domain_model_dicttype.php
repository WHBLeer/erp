...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:erp_management_dict/Resources/Private/Language/locallang_db.xlf:tx_erpmanagementdict_domain_model_dicttype',
        'label' => 'name',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_erpmanagementdict_domain_model_dicttype}.{#pid}=###CURRENT_PID### AND {#tx_erpmanagementdict_domain_model_dicttype}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'name' => [
            'exclude' => true,
            'label' => 'LLL:EXT:erp_management_dict/Resources/Private/Language/locallang_db.xlf:tx_erpmanagementdict_domain_model_dicttype.name',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
