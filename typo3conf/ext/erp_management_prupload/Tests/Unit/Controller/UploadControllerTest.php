<?php
namespace ERP\ErpManagementPrupload\Tests\Unit\Controller;
...
{
    /**
     * @var \ERP\ErpManagementPrupload\Controller\UploadController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\ERP\ErpManagementPrupload\Controller\UploadController::class)
    ...
    public function listActionFetchesAllUploadsFromRepositoryAndAssignsThemToView()
    {
        ...
        $uploadRepository = $this->getMockBuilder(\ERP\ErpManagementPrupload\Domain\Repository\UploadRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $upload = new \ERP\ErpManagementPrupload\Domain\Model\Upload();
