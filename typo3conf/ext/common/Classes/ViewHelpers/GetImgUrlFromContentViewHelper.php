...
class GetImgUrlFromContentViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper {
    ...
    public function initializeArguments()
    {
        ...
        $this->registerArgument('defaultImage', 'string', 'mobileMaxHeight', false);
    }
    ...
    public function render() {
        ...
        if(isset($matches[1])){
            ...
            //如果没有图片,返回默认图片
            $defaultImage = 'https://picsum.photos/400/500/?random';
            // $defaultImage = str_replace('EXT:','typo3conf/ext/',$defaultImage);
            return $defaultImage;
        }
    }
