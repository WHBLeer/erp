...
class ComController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
    ...
    protected $addressController = null;
    ...
    public function initializeAction()
    {
        ...
        $this->addressController = $this->objectManager->get(\ERP\ErpManagementOrder\Controller\AddressController::class);
        $this->revenueController = $this->objectManager->get(\ERP\ErpManagementOrder\Controller\RevenueController::class);
        $this->shipperController = $this->objectManager->get(\ERP\ErpManagementOrder\Controller\ShipperController::class);
    ...
    {
        return $this->addressController->saveAddress();
    }
    ...
    {
        return $this->revenueController->saveRevenue($data);
    }
    ...
    {
        return $this->shipperController->saveShipper($data);
    }
