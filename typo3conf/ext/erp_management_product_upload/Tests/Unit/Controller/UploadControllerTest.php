<?php
namespace ERP\ErpManagementProductUpload\Tests\Unit\Controller;
...
{
    /**
     * @var \ERP\ErpManagementProductUpload\Controller\UploadController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\ERP\ErpManagementProductUpload\Controller\UploadController::class)
    ...
    public function listActionFetchesAllUploadsFromRepositoryAndAssignsThemToView()
    {
        ...
        $uploadRepository = $this->getMockBuilder(\ERP\ErpManagementProductUpload\Domain\Repository\UploadRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $upload = new \ERP\ErpManagementProductUpload\Domain\Model\Upload();
