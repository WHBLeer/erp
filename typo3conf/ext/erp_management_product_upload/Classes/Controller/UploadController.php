<?php
namespace ERP\ErpManagementProductUpload\Controller;
...
class UploadController extends ComController
{
     ...
     * uploadRepository
     * 
     * @var \ERP\ErpManagementProductUpload\Domain\Repository\UploadRepository
     * @inject
     */
     ...
     * action list
     * 
     * @param ERP\ErpManagementUploadUpload\Domain\Model\Upload
     * @return void
     */
     ...
     * @return void
     */
    public function showAction(\ERP\ErpManagementProductUpload\Domain\Model\Upload $upload)
    {
     ...
     * @return void
     */
    public function createAction(\ERP\ErpManagementProductUpload\Domain\Model\Upload $upload)
    {
     ...
     * @return void
     */
    public function editAction(\ERP\ErpManagementProductUpload\Domain\Model\Upload $upload)
    {
        $this->view->assign('product', $product);
        $this->view->assign('approvals', $this->getApprovals());
        $this->view->assign('shelvess', $this->getShelves());
     ...
     * @return void
     */
    public function updateAction(\ERP\ErpManagementProductUpload\Domain\Model\Upload $upload)
    {
        $datas = $this->request->getArguments();
     ...
     * @return void
     */
    public function deleteAction(\ERP\ErpManagementProductUpload\Domain\Model\Upload $upload)
    {
