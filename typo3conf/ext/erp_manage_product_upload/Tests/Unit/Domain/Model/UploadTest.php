<?php
namespace ERP\ErpManageProductUpload\Tests\Unit\Domain\Model;
...
{
    /**
     * @var \ERP\ErpManageProductUpload\Domain\Model\Upload
     */
    ...
    {
        parent::setUp();
        $this->subject = new \ERP\ErpManageProductUpload\Domain\Model\Upload();
    }
