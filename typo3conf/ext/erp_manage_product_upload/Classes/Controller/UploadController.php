<?php
namespace ERP\ErpManageProductUpload\Controller;
...
class UploadController extends ComController
{
     ...
     * uploadRepository
     * 
     * @var \ERP\ErpManageProductUpload\Domain\Repository\UploadRepository
     * @inject
     */
     ...
     * action list
     * 
     * @param ERP\ErpManageUploadUpload\Domain\Model\Upload
     * @return void
     */
     ...
     * @return void
     */
    public function showAction(\ERP\ErpManageProductUpload\Domain\Model\Upload $upload)
    {
     ...
     * @return void
     */
    public function createAction(\ERP\ErpManageProductUpload\Domain\Model\Upload $upload)
    {
     ...
     * @return void
     */
    public function editAction(\ERP\ErpManageProductUpload\Domain\Model\Upload $upload)
    {
        $this->view->assign('product', $product);
        $this->view->assign('approvals', $this->getApprovals());
        $this->view->assign('shelvess', $this->getShelves());
     ...
     * @return void
     */
    public function updateAction(\ERP\ErpManageProductUpload\Domain\Model\Upload $upload)
    {
        $datas = $this->request->getArguments();
     ...
     * @return void
     */
    public function deleteAction(\ERP\ErpManageProductUpload\Domain\Model\Upload $upload)
    {
