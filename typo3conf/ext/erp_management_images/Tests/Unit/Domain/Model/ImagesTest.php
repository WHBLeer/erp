 ...
 */
class ImagesTest extends \TYPO3\TestingFramework\Core\Unit\UnitTestCase
{
    /**
     * @var \ERP\ErpManagementImages\Domain\Model\Images
     */
    ...
    {
        parent::setUp();
        $this->subject = new \ERP\ErpManagementImages\Domain\Model\Images();
    }
